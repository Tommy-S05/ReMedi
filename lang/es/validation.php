...
return [
    ...
    'values'                        => [
        'schedules' => [
            '*' => [
                'frequency_type' => [
                    'hourly_interval'  => 'intervalo por horas',
                    'interval_in_days' => 'intervalo en días',
    ...
    'attributes'                    => [
        ...
        'rules'                         => 'reglas',
        'schedule'                      => 'horario',
        'schedules.*.days_of_week.*'    => 'día de la semana',
        'schedules.*.end_date'          => 'fecha de fin',
        'schedules.*.frequency_type'    => 'frecuencia',
        'schedules.*.id'                => 'ID del horario',
        'schedules.*.interval_in_days'  => 'intervalo en días',
        'schedules.*.interval_in_hours' => 'intervalo en horas',
        'schedules.*.start_date'        => 'fecha de inicio',
        'schedules.*.time_to_take'      => 'hora de toma',
        'second'                        => 'segundo',
        'sex'                           => 'sexo',
        'shipment'                      => 'envío',
    ...
    'custom'                        => [
        'schedules' => [
            '*' => [
                'days_of_week'      => [
                    'required_if' => 'Debe seleccionar al menos un día cuando :other es días específicos.',
                ],
                'interval_in_days'  => [
                    'required_if' => 'El :attribute es obligatorio cuando :other es intervalo en días.',
                ],
                'interval_in_hours' => [
                    'required_if' => 'El :attribute es obligatorio cuando :other es intervalo por horas.',
                ],
            ],
        ],
    ],
